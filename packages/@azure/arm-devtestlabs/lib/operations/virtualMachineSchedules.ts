...
export class VirtualMachineSchedules {
   ...
   */
  list(resourceGroupName: string, labName: string, virtualMachineName: string, callback: msRest.ServiceCallback<Models.ResponseWithContinuationSchedule>): void;
  /**
   * @param resourceGroupName The name of the resource group.
   * @param labName The name of the lab.
   * @param virtualMachineName The name of the virtual machine.
   ...
   * @param callback The callback
   */
  list(resourceGroupName: string, labName: string, virtualMachineName: string, options: Models.VirtualMachineSchedulesListOptionalParams, callback: msRest.ServiceCallback<Models.ResponseWithContinuationSchedule>): void;
  list(resourceGroupName: string, labName: string, virtualMachineName: string, options?: Models.VirtualMachineSchedulesListOptionalParams | msRest.ServiceCallback<Models.ResponseWithContinuationSchedule>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationSchedule>): Promise<Models.VirtualMachineSchedulesListResponse> {
  ...
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ResponseWithContinuationSchedule>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationSchedule>): Promise<Models.VirtualMachineSchedulesListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
