...
export class CustomImages {
  ...
  list(resourceGroupName: string, labName: string, options?: Models.CustomImagesListOptionalParams | msRest.ServiceCallback<Models.ResponseWithContinuationCustomImage>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationCustomImage>): Promise<Models.CustomImagesListResponse> {
  ...
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ResponseWithContinuationCustomImage>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationCustomImage>): Promise<Models.CustomImagesListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
