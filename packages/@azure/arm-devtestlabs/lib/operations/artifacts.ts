...
export class Artifacts {
  ...
  list(resourceGroupName: string, labName: string, artifactSourceName: string, options?: Models.ArtifactsListOptionalParams | msRest.ServiceCallback<Models.ResponseWithContinuationArtifact>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationArtifact>): Promise<Models.ArtifactsListResponse> {
  ...
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ResponseWithContinuationArtifact>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationArtifact>): Promise<Models.ArtifactsListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
