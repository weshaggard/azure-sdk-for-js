...
export class ArtifactSources {
  ...
  list(resourceGroupName: string, labName: string, options?: Models.ArtifactSourcesListOptionalParams | msRest.ServiceCallback<Models.ResponseWithContinuationArtifactSource>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationArtifactSource>): Promise<Models.ArtifactSourcesListResponse> {
  ...
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ResponseWithContinuationArtifactSource>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationArtifactSource>): Promise<Models.ArtifactSourcesListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
