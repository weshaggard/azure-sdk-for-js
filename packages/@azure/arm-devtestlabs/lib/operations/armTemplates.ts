...
export class ArmTemplates {
  ...
  list(resourceGroupName: string, labName: string, artifactSourceName: string, options?: Models.ArmTemplatesListOptionalParams | msRest.ServiceCallback<Models.ResponseWithContinuationArmTemplate>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationArmTemplate>): Promise<Models.ArmTemplatesListResponse> {
  ...
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ResponseWithContinuationArmTemplate>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationArmTemplate>): Promise<Models.ArmTemplatesListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
