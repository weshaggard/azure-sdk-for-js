...
export class Formulas {
  ...
  list(resourceGroupName: string, labName: string, options?: Models.FormulasListOptionalParams | msRest.ServiceCallback<Models.ResponseWithContinuationFormula>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationFormula>): Promise<Models.FormulasListResponse> {
  ...
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ResponseWithContinuationFormula>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationFormula>): Promise<Models.FormulasListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
