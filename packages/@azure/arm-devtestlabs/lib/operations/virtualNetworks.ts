...
export class VirtualNetworks {
  ...
  list(resourceGroupName: string, labName: string, options?: Models.VirtualNetworksListOptionalParams | msRest.ServiceCallback<Models.ResponseWithContinuationVirtualNetwork>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationVirtualNetwork>): Promise<Models.VirtualNetworksListResponse> {
  ...
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ResponseWithContinuationVirtualNetwork>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationVirtualNetwork>): Promise<Models.VirtualNetworksListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
