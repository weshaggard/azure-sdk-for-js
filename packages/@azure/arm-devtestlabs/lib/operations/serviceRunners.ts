...
export class ServiceRunners {
  ...
  list(resourceGroupName: string, labName: string, options?: Models.ServiceRunnersListOptionalParams | msRest.ServiceCallback<Models.ResponseWithContinuationServiceRunner>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationServiceRunner>): Promise<Models.ServiceRunnersListResponse> {
  ...
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ResponseWithContinuationServiceRunner>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationServiceRunner>): Promise<Models.ServiceRunnersListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
