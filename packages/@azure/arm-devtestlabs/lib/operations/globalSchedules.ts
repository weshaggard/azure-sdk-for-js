...
export class GlobalSchedules {
  ...
  listBySubscription(options?: Models.GlobalSchedulesListBySubscriptionOptionalParams | msRest.ServiceCallback<Models.ResponseWithContinuationSchedule>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationSchedule>): Promise<Models.GlobalSchedulesListBySubscriptionResponse> {
  ...
  listBySubscriptionNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ResponseWithContinuationSchedule>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationSchedule>): Promise<Models.GlobalSchedulesListBySubscriptionNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
  ...
  listByResourceGroupNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ResponseWithContinuationSchedule>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationSchedule>): Promise<Models.GlobalSchedulesListByResourceGroupNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
