...
export class VirtualMachines {
  ...
  list(resourceGroupName: string, labName: string, options?: Models.VirtualMachinesListOptionalParams | msRest.ServiceCallback<Models.ResponseWithContinuationLabVirtualMachine>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationLabVirtualMachine>): Promise<Models.VirtualMachinesListResponse> {
  ...
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ResponseWithContinuationLabVirtualMachine>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationLabVirtualMachine>): Promise<Models.VirtualMachinesListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
