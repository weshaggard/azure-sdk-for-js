...
export class Environments {
  ...
  list(resourceGroupName: string, labName: string, userName: string, options?: Models.EnvironmentsListOptionalParams | msRest.ServiceCallback<Models.ResponseWithContinuationDtlEnvironment>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationDtlEnvironment>): Promise<Models.EnvironmentsListResponse> {
  ...
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ResponseWithContinuationDtlEnvironment>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationDtlEnvironment>): Promise<Models.EnvironmentsListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
