...
export class Disks {
  ...
  list(resourceGroupName: string, labName: string, userName: string, options?: Models.DisksListOptionalParams | msRest.ServiceCallback<Models.ResponseWithContinuationDisk>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationDisk>): Promise<Models.DisksListResponse> {
  ...
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ResponseWithContinuationDisk>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationDisk>): Promise<Models.DisksListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
