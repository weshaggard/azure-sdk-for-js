...
export class Policies {
  ...
  list(resourceGroupName: string, labName: string, policySetName: string, options?: Models.PoliciesListOptionalParams | msRest.ServiceCallback<Models.ResponseWithContinuationPolicy>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationPolicy>): Promise<Models.PoliciesListResponse> {
  ...
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ResponseWithContinuationPolicy>, callback?: msRest.ServiceCallback<Models.ResponseWithContinuationPolicy>): Promise<Models.PoliciesListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
